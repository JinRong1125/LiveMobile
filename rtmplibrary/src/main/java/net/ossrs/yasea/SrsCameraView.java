...
public class SrsCameraView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    public void setPreviewOrientation(int orientation) {
        ...
        int rotation = ((WindowManager)(getContext().getApplicationContext().getSystemService(Context.WINDOW_SERVICE))).getDefaultDisplay().getRotation();
        int degrees = 0;
        switch (rotation) {
        ...
        if (info.facing == Camera.CameraInfo.CAMERA_FACING_BACK) {
            ...
            mPreviewRotation = (360 - mPreviewRotation) % 360;
        }
/*
